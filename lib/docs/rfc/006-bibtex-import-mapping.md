...
**Status:** Locked (v3) — all questions resolved, PR-0 starting
**Author:** Captain + Claude
**Date:** 2026-05-11 (v1, v2, v3 same day)
...
Importer in PR-2 may overwrite freely when the flag is `true`. Lands
in PR-0 alongside `wasDeduped`.
