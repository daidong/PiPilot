...
# Quality level definitions by minimum score threshold (inclusive).
# This avoids numeric gaps (e.g., 3.96) falling into "Unknown".
QUALITY_THRESHOLDS = [
...
def get_quality_level(score: float) -> tuple:
    ...
    for min_score, (level, description) in QUALITY_THRESHOLDS:
        if score >= min_score:
