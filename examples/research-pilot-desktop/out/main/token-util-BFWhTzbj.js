...
function requireTokenIo() {
  ...
  var import_path = __toESM(path);
  var import_fs = __toESM(require$$1);
  var import_os = __toESM(require$$2);
  var import_token_error = index.requireTokenError();
...
function requireTokenUtil() {
  ...
  function saveToken(token, projectId) {
    ...
    fs.mkdirSync(path$1.dirname(tokenPath), { mode: 504, recursive: true });
...
exports.requireTokenUtil = requireTokenUtil;
